...
class Definitions {
  ...
  @tu lazy val UniqueAnnot: ClassSymbol = requiredClass("scala.annotation.unique")
  @tu lazy val HasUniqueAnnot: ClassSymbol = requiredClass("scala.annotation.internal.HasUnique")
